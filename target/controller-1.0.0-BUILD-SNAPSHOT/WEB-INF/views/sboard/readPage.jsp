...
<form role="form" method="post" action="readPage">
	...
	<div class="box">
		...
		<div class="box-footer">
			<c:if test="${login.uid == boardVO.writer}">
				<button type="submit" class="btn btn-warning" id="pageModBtn">Modify</button>
				<button type="submit" class="btn btn-danger" id="pageDelBtn">REMOVE</button>
			</c:if>
						
			<button type="submit" class="btn btn-primary" id="backListBtn">LIST ALL</button>
		</div>
	</div>
...
<script>
	...
	$(document).ready(function(){
		...
		$("#pageModBtn").on("click", function(){
			formObj.attr("action", "/sboard/modifyPage");
			formObj.attr("method", "get");
			formObj.submit();
		});
		
		$("#pageDelBtn").on("click", function(){
		...
		$("#replyAddBtn").on("click", function(){
			...
			$.ajax({
				...
				success: function(result){
					...
					//console.log('bno: ' + bno + ', replyPage: ' + replyPage);
					if(result == 'SUCCESS'){
						alert('등록되었습니다.');
						replyPage = 1;						
						getPage("/replies/" + bno + "/" + replyPage);
